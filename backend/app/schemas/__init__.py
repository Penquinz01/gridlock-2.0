...
class RouteInput(BaseModel):
    """Input for incident-aware route calculation."""
    origin: RoutePoint
    ...
    model_config = {"json_schema_extra": {
        "examples": [{
            ...
            "destination": {"latitude": 13.04, "longitude": 77.52}
        }]
    }}


class IncidentOnRoute(BaseModel):
    """An active incident that the route passes near."""
    incident_id: str
    priority: str
...
class RouteResponse(BaseModel):
    ...
    incidents_on_route: list[IncidentOnRoute]
    is_clean_route: bool
    warnings: list[str]
    map_url: str
