...
const UserRole = () => {
  ...
  const findRoute = async () => {
    if (!routeParams.origin.lat || !routeParams.destination.lat) return;
    
    // Automatically confirm/lock both origin and destination
    setRouteParams(prev => ({
      origin: { ...prev.origin, confirmed: true },
      destination: { ...prev.destination, confirmed: true }
    }));
      ...
      <div style={{ flex: 1, position: 'relative', height: '100%' }}>
        ...
        <div className="glass-panel flex-col gap-4 animate-slide-in" style={{ 
          ...
          <button 
            ...
            disabled={!routeParams.origin.lat || !routeParams.destination.lat || routeLoading}
            onClick={findRoute}
          >
